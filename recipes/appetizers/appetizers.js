var buttons = document.getElementsByClassName("appetizerButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("appetizerRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Appetizer Recipes";
        document.body.style.background = "";
        document.getElementById("appetizerRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
