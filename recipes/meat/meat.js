var buttons = document.getElementsByClassName("meatButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("meatRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Meat Recipes";
        document.body.style.background = "";
        document.getElementById("meatRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
