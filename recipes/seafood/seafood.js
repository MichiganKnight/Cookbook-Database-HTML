var buttons = document.getElementsByClassName("seafoodButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("seafoodRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Seafood Recipes";
        document.body.style.background = "";
        document.getElementById("seafoodRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
