var buttons = document.getElementsByClassName("sideButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("sideRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Side Recipes";
        document.body.style.background = "";
        document.getElementById("sideRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
