var buttons = document.getElementsByClassName("saladButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("saladRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Salad Recipes";
        document.body.style.background = "";
        document.getElementById("saladRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
