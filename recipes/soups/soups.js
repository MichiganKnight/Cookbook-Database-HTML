var buttons = document.getElementsByClassName("soupButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("soupRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Soup Recipes";
        document.body.style.background = "";
        document.getElementById("soupRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
