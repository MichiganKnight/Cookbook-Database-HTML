var buttons = document.getElementsByClassName("miscButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("miscRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Misc Recipes";
        document.body.style.background = "";
        document.getElementById("miscRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
