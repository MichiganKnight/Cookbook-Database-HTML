var buttons = document.getElementsByClassName("dessertButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("dessertRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Dessert Recipes";
        document.body.style.background = "";
        document.getElementById("dessertRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
