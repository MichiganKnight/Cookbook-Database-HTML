var buttons = document.getElementsByClassName("poultryButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("poultryRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Poultry Recipes";
        document.body.style.background = "";
        document.getElementById("poultryRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
