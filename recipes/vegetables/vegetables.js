var buttons = document.getElementsByClassName("vegetableButtons");
for (var i = 0; i < buttons.length; i++) {
    ...
    document.getElementById(buttonId).addEventListener('click', (event) => {
        ...
        document.getElementById("vegetableRecipes").style.display = "none";
...
document.getElementById('btnGoBack').onclick = function () {
    if (document.body.style.background == "") {
        ...
        document.title = "Vegetable Recipes";
        document.body.style.background = "";
        document.getElementById("vegetableRecipes").style.display = "block";
        var table = document.getElementById("btn-group");
